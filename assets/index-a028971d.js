...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:cn,depthTest:!1,depthWrite:!1})}function xa(){return new fn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ps(),fragmentShader:`
...
`].filter(di).join(`
`)),a=Ms(a),a=La(a,t),a=Da(a,t),o=Ms(o),o=La(o,t),o=Da(o,t),a=Ua(a),o=Ua(o),t.isRawShaderMaterial!==!0&&(A=`#version 300 es
